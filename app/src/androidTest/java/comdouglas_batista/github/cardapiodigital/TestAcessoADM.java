...
public class TestAcessoADM {
    ...
    public void testAcessoADM() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.pinadm), withText("1234"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.btnAdmin), withText("Entrar"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
